...
say('Victoria Rosalind', { font: 'chrome', align: 'center', gradient: ['blue', 'green'] })
say(`Victoria Rosalind By Clayza Aubert`, { font: 'console', align: 'center', gradient: ['blue', 'green'] })
